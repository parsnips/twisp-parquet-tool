...
func parseConfig(args []string) (config, error) {
	...
	fs.IntVar(&c.Workers, "workers", 16, "Concurrent Parquet downloads (1–512)")
	...
	if c.PageSize < 1 || c.PageSize > 1000 || c.Workers < 1 || c.Workers > 512 || c.ImportWorkers < 1 || c.ImportWorkers > 64 || c.Retries < 0 || c.Retries > 10 || c.Timeout <= 0 {
		return c, errors.New("require page-size 1–1000, workers 1–512, import-workers 1–64, retries 0–10, and a positive timeout")
	}
